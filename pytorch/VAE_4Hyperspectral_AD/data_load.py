...
def get_dataloader():
    ...
    val_loader = torch.utils.data.DataLoader(val_datasets, batch_size=128, shuffle=True, num_workers=0, pin_memory=True,
                                         drop_last=False)
...
def all_dataloader():
    ...
    train_dataset, val_set = torch.utils.data.random_split(train_dataset, 
